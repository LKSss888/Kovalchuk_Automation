...
# Деление на три. Создайте функцию dev_by_three , которая принимает один аргумент — число — и возвращает 'Да', если оно делится на три, и 'Нет' — если не делится. 
# В этом же файле напишите код, который вызывает функцию и передает в нее число. Результат вызова функции должен сохраняться в переменную. 
...
#_________________________________________________________________________________________________________________________________________________________________
# Изучите статью: https://pythonchik.ru/osnovy/python-range. Создайте список [25, 20, 15, 10, 5] с помощью функции range() и выведите его на экран.
